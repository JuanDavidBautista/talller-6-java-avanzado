...
<head>
    ...
    <title>Formulario De Registro De Productos RICK</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/reP.css">
</head>
...
<main class="form-signin w-100 m-auto">
    <form action="" method="post">
        ...
        <div class="form-floating">
            <input type="number" class="form-control" id="floatingValue"
        ...
        <div class="form-floating">
            <input type="number" class="form-control" id="floatingCategory"
